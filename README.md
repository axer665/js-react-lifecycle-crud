...
Backend вы можете либо написать сами, либо взять готовый из [репозитория](https://github.com/axer665/js-react-lifecycle-crud-server) (https://github.com/axer665/js-react-lifecycle-crud-server).
